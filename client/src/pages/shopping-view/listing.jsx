    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 p-4">
      ...
      <div className="lg:col-span-1">
        ...
        <div className='mt-2 p-4 flex flex-col gap-5'>
          ...
          <Input icon={PencilLine} iconKeep='true' iconColor='text-black' bgColor='bg-zinc-100' borderColor='border-zinc-700' placeHolderColor='text-zinc-300' placeholder='Description' />
        </div>
      </div>
