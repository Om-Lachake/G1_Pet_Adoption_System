  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 bg-background border-b" >
      ...
      <div className='flex flex-1 justify-end'>
        <button onClick={handleLogout} className=' mt-4 w-fit  bg-blue-500 text-white  inline-flex items-center rounded-md px-4 py-2 text-sm font-medium shadow gap-2' >
        <LogOut />
          Logout
        </button>
      </div>
